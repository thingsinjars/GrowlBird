...
@implementation GrowlBirdWindowView
...
- (void) drawRect:(NSRect)rect {
	...
	int effect = Bird_EFFECT_SLIDE;
	READ_GROWL_PREF_BOOL(Bird_EFFECT_PREF, SamplePrefDomain, &effect);
...
- (void) setPriority:(int)priority {
	...
	switch (priority) {
		case -2:
			key = GrowlBirdVeryLowBackgroundColor;
			textKey = GrowlBirdVeryLowTextColor;
			break;
		case -1:
			key = GrowlBirdModerateBackgroundColor;
			textKey = GrowlBirdModerateTextColor;
			break;
		case 1:
			key = GrowlBirdHighBackgroundColor;
			textKey = GrowlBirdHighTextColor;
			break;
		case 2:
			key = GrowlBirdEmergencyBackgroundColor;
			textKey = GrowlBirdEmergencyTextColor;
			break;
		case 0:
		default:
			key = GrowlBirdNormalBackgroundColor;
			textKey = GrowlBirdNormalTextColor;
			break;
	}

	[backgroundColor release];

	float opacityPref = Bird_DEFAULT_OPACITY;
	READ_GROWL_PREF_FLOAT(Bird_OPACITY_PREF, SamplePrefDomain, &opacityPref);
